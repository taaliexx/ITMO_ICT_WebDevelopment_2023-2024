### Информация о комнатах и добавление новой комнаты
...
### Получение информации о свободных номерах в заданный период
...
### Получение информации о бронированиях, а также заселение и выселение клиента
