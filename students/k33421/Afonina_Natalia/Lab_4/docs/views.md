### Простые пробные классы для получения списка комнат, клиентов, работников отеля, а также для создания новой комнаты в отеле
К данной информации есть доступ у всех зарегистрированных в системе пользователей, у которых есть токен
...
### Получение информации о клиентах, проживавших в заданном номере, в заданный период времени
Форма html, в которой необходимо выбрать номер комнаты и период времени проживания, далее происходит переход на страницу с запрашиваемой информацией
...
### Получение информации о количестве клиентов, прибывших из заданного города
...
### Получение информации о том, кто из служащих убирал номер указанного клиента в заданный день недели
...
### Получение информации, сколько в гостинице свободных номеров в указанный промежуток времени
...
### Cписок клиентов с указанием места жительства, которые проживали в те же дни, что и заданный клиент, в определенный период времени.
...
### Действия доступные только администратору гостиницы 
...
### Отчет о работе гостиницы за указанный квартал выбранного года. 

Такой отчет содержит следующие сведения:

* число клиентов за указанный период в каждом номере
* количество номеров не каждом этаже
* общая сумма дохода за каждый номер

Доступ к отчету есть только у администратора
