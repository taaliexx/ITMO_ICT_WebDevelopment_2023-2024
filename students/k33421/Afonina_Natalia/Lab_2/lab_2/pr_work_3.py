...
user_natal = CustomUser.objects.create(id=1)


booking_user_polilaa_1 = Bookings.objects.create(user=user_polilaa, room=single_room_3, check_in='2023-11-25', check_out='2023-11-26')
booking_user_polilaa_2 = Bookings.objects.create(user=user_polilaa, room=double_room_2, check_in='2023-11-24 16:00:00', check_out='2023-11-26 16:00:00')
booking_user_natal_1 = Bookings.objects.create(user=user_natal, room=family_room_2, check_in='2023-12-01', check_out='2023-12-05')
...
review_1 = Review.objects.create(user=user_polilaa, rating=9, text="Great room!", room=single_room_3, booking=booking_user_polilaa_1)
...
review_3 = Review.objects.create(user=user_natal, rating=8, text="Good experience!", room=family_room_2, booking=booking_user_natal_1)
