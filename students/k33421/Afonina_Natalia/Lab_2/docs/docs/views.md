* Все категории номеров отеля
* Все бронирования конкретного пользователя
* Детальное описание номера с возможностью его забронировать
* Отмена и изменение бронирования
* Все отзывы
* Добавление отзыва
* Стартовые страницы для авторизированного и неавторизированного пользователей
